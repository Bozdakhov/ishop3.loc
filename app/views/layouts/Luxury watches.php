...
<div class="information">
    <div class="container">
        <div class="infor-top">
            ...
            <div class="col-md-3 infor-left">
                <h3>Watch Store Information</h3>
                <h4>Ghost Team,
                    <span>Trademarks,</span>
                    Chilanzar 7 24.</h4>
                <h5>+99890 1671385</h5>
                <p><a href="mailto:jenisbozdak@gmail.com">contact@jenis.com</a></p>
            </div>
            <div class="clearfix"></div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="footer-top">
            ...
            <div class="col-md-6 footer-right">
                <p>© 2024 Luxury Watches. All Rights Reserved | Design by  <a href="http://wwww.3layouts.com/" target="_blank">Ghost Team</a> </p>
            </div>
            <div class="clearfix"></div>
        </div>
    </div>
