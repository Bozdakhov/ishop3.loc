...
<div class="wrapper">
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2020-2024 <a href="https://adminlte.io">Ghost Team</a>.</strong> All rights
        reserved.
    </footer>
                ...
                <ul class="control-sidebar-menu">
                    <li>
                        <a href="javascript:void(0)">
                            ...
                            <div class="menu-info">
                                <h4 class="control-sidebar-subheading">Sarvars's Birthday</h4>
                    ...
                    <li>
                        <a href="javascript:void(0)">
                            ...
                            <div class="menu-info">
                                <h4 class="control-sidebar-subheading">Aziz Updated His Profile</h4>

                                <p>New phone (+99890)1671385</p>
                            </div>
                        </a>
                    </li>
                    <li>
